...
ThisBuild / organization     := "domtech"
ThisBuild / organizationName := "DomTeCH"
...
// test
    ...
    Libraries.zioTestSbt.value,
    Libraries.zioTestMagnolia.value
    //Libraries.ziotest("junit"),zioTestMagnolia
